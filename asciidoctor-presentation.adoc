...
Again, as a not native backend, it requires a *complementary install*, which is described here https://github.com/asciidoctor/asciidoctor-reveal.js#revealjs-backend-for-asciidoctor. +
